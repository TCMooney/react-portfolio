...
class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: '',
      featured_image: '',
      apiUrl: 'https://tommooney.devcamp.space/portfolio/portfolio_blogs',
      apiAction: 'post'
    }
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://tommooney.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: 'patch'
      })
    }
  }
  ...
  buildForm() {
    ...
    formData.append('protfolio_blog[blog_status]', this.state.blog_status);
